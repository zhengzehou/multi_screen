...
//        }
     ...
     * imgQrcode - ImageView
     */
    public static byte[] createQRBytes(String address, int size) {
        byte[] appicon = null;
        String str = "";
        try{
//            Hashtable<EncodeHintType, String> hints = new Hashtable<>();
//            hints .put(EncodeHintType.CHARACTER_SET, "utf-8");
//            // 图像数据转换
//            BitMatrix bitMatrix = new QRCodeWriter().encode(address, BarcodeFormat.QR_CODE,size,size, hints);
//            int[] pixels = new int[size * size];
//            for (int y= 0;y< size;y++){
//                for (int x= 0; x< size; x++){
//                    if (bitMatrix.get(x, y)) {
//                        pixels[y * size + x] = 0x000000;
//                    }else {
//                        pixels[y * size + x] = 0xfffff;
//                    }
////                imgQrcode.setlmageBitmap(bitmap);
//                }
//            }
...
//            Bitmap bitmap = BitmapFactory.decodeStream(bis);
            Bitmap bitmap = BitmapUtils.fromText(size,"testsdfsdfsdf");
