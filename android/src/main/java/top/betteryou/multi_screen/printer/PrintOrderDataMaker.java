...
import top.betteryou.multi_screen.utils.PrinterWriter;
...
public class PrintOrderDataMaker {
...
//            ArrayList<byte[]> image1 = printer.getImageByte(btService.getResources(), R.drawable.icon);
////
//            data.addAll(image1);
